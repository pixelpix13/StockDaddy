...
const NAV_ICONS: Record<string, React.ReactNode> = {
  ...
  '/companies': <Briefcase className="w-5 h-5" />,
...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-40 h-screen w-64 glass-panel border-r border-border flex flex-col justify-between transition-transform duration-300 ease-in-out md:translate-x-0 ${
      ...
      >
        ...
        <div className="p-4 border-t border-border">
          <div className="flex items-center justify-between p-2.5 rounded-xl bg-card/60 border border-border">
