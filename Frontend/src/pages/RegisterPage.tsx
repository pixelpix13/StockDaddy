    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Create your user account</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-3xl border border-border shadow-2xl">
          <div className="flex items-center justify-between pb-4 mb-6 border-b border-border">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Register and receive JWT session token</p>
            </div>
