        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductBundles_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaxRegions_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaxRegions_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IntegrationEvents_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoldBy = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ProductBundleId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BundleSaleItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BundleSaleItems_ProductBundles_ProductBundleId",
                        column: x => x.ProductBundleId,
                        principalTable: "ProductBundles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BundleSaleItems_Sales_SaleId",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsWrapped = table.Column<bool>(type: "boolean", nullable: false),
                    WrapType = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GiftOptions_Sales_SaleId",
                        column: x => x.SaleId,
                        principalTable: "Sales",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    StoreId1 = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                    EffectiveUnitPrice = table.Column<decimal>(type: "numeric", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BundleItems_ProductBundles_ProductBundleId",
                        column: x => x.ProductBundleId,
                        principalTable: "ProductBundles",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "integer", nullable: false),
                    StoreId = table.Column<int>(type: "integer", nullable: false),
                    HSNCodeId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    HSNMasterId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductVariants_HsnMaster_HSNMasterId",
                        column: x => x.HSNMasterId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StockItems_Users_UpdatedByUserId",
            ...
            migrationBuilder.CreateTable(
                name: "AdjustedInvoices",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    InvoiceId = table.Column<int>(type: "integer", nullable: false),
                    AdjustedTotalAmount = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdjustedInvoices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdjustedInvoices_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdjustedInvoices_Users_AdjustedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Refunds_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductRestockAlerts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductRestockAlerts_ProductVariants_VariantId",
                        column: x => x.VariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductRestockAlerts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductRestockAlerts_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdjustedInvoices_AdjustedByUserId",
                table: "AdjustedInvoices",
                column: "AdjustedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AdjustedInvoices_InvoiceId",
                table: "AdjustedInvoices",
                column: "InvoiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BundleItems_ProductBundleId",
                table: "BundleItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BundleSaleItems_ProductBundleId",
                table: "BundleSaleItems",
                column: "ProductBundleId");

            migrationBuilder.CreateIndex(
                name: "IX_BundleSaleItems_SaleId",
                table: "BundleSaleItems",
                column: "SaleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IntegrationEvents_StoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRestockAlerts_ProductId",
                table: "ProductRestockAlerts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductRestockAlerts_StoreId",
                table: "ProductRestockAlerts",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductRestockAlerts_VariantId",
                table: "ProductRestockAlerts",
                column: "VariantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_HSNMasterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockItems_UpdatedByUserId",
                table: "StockItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaxRegions_StoreId",
                table: "TaxRegions",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_TaxRegions_TenantId",
                table: "TaxRegions",
                column: "TenantId");
