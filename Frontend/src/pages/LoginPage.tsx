    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-foreground tracking-tight">StockDaddy</h1>
          <p className="text-muted-foreground text-sm mt-1">Multi-tenant Inventory & Point of Sale System</p>
        </div>

        {/* Card Form */}
        <div className="glass-panel p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-border shadow-2xl">
          <div className="flex items-center justify-between pb-4 mb-6 border-b border-border">
            <div>
              <h2 className="text-lg font-bold text-foreground">Authentication</h2>
              <p className="text-xs text-muted-foreground">Sign in with your JWT credentials</p>
            </div>
